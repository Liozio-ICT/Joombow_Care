...
function Signup() {
  ...
  const handleSignup = async () => {
    try {
      ...
      const response = await axios.post("https://authhh.onrender.com/signup", {
        userName,
        email,
        password,
        phoneNumber,
  ...
  return (
    <>
      ...
      <body className="lg:hidden">
        <main className="px-6 min-h-[100vh] bg-black pb-[2rem]">
          ...
          <h2 className="text-[1.7rem] text-[#FFFFFF] font-clash capitalize font-bold mb-8">
            SignUp
          </h2>
          <form class="mt-[1rem]" id="registrationForm">
            <div class="inputCon py-2">
              ...
              <input
                ...
                className={`bg-[#FCFBFB] focus:border focus:border-gray-300 capitalize border-[1px] border-slate-200 outline-none w-full py-[.6rem] rounded-[5px] mb-1 mt-1 px-4 ${
                  message && !userName ? "border-red-500" : ""
                }`}
              />
            </div>
            ...
            <div class="inputCon py-2">
              ...
              <input
                ...
                id="email"
                type="text"
                className={`bg-[#FCFBFB] focus:border focus:border-gray-300 capitalze border-[1px] border-slate-200 outline-none w-full py-[.6rem] rounded-[5px] mb-1 mt-1 px-4 ${
            ...
            <button
              ...
              class="btn mt-6 text-[18px] font-montserrat hover:text-[#ffffff] text-white font-semibold cursor-pointer w-full rounded-md outline-none py-3 bg-[#FD1014] hover:bg-[#E3383B] transition">
              Next
            </button>

            <div className="text-[#FFFFFF] my-3">
              <h2>
            ...
            <button
              type="button"
              onClick={handleOAuth}
              className="w-full border-red-500 border py-3 px-4 rounded-[10px] flex items-center text-[18px] font-semibold mon justify-center hover:bg-[#E3383B] hover:text-[#FCFBFB] text-[#FFFFFF] duration-300 ease-in-out transition">
        ...
        <div className="r w-full hidden lg:block ">
          ...
          <div className="absolute inset-0 flex justify-center  w-full  text-white  px-6 ">
            <form
              ...
              <div class="inputCon w-full py-1">
                ...
                <input
                  ...
                  id="userName"
                  type="text"
                  className={` border-[1px] text-[#010102] font-montserrat font-normal text-[14px] border-slate-200 outline-none w-full py-[.6rem] rounded-[5px] px-4 bg-[#FCFBFB] focus:border focus:border-gray-400 mb-2 ${
                    message && !userName ? "border-red-500" : ""
                  }`}
                />
              </div>

              <div class="inputCon my-[.3rem] py-1">
                <label class="block text-slate-100 font-semibold text-[16px]">
                  Email:
                </label>
                <input
                  ...
                  id="email"
                  type="text"
                  className={`border-[1px] text-[#010102] font-montserrat font-normal text-[14px] mt-1 mb-2  border-slate-200 outline-none w-full py-[.6rem] rounded-[5px] px-4 bg-[#FCFBFB] focus:border focus:border-gray-400 ${
                    message && !email ? "border-red-500" : ""
                  }`}
                />
              </div>
              ...
              <div class="inputCon my-[.3rem] py-1">
                ...
                <input
                  ...
                  id="phoneNumber"
                  type="text"
                  className={`border-[1px] text-[#010102] font-montserrat font-normal text-[14px] mb-2  border-slate-200 outline-none w-full py-[.6rem] rounded-[5px] px-4 bg-[#FCFBFB] focus:border focus:border-gray-400 ${
                    message && !phoneNumber ? "border-red-500" : ""
                  }`}
                />
              </div>

              <div class="inputCon py-1">
                <label class="block text-slate-100 font-semibold text-[16px]">
                  Password:
                </label>
                <input
              ...
              <button
                ...
                w-full rounded-md outline-none py-3 bg-[#FD1014] hover:bg-[#E3383B] duration-300 ease-in-out mt-4 transition">
                Next
              </button>
              ...
              <button
                ...
                py-3 px-4 rounded-[10px] flex items-center duration-300 ease-in-out text-[18px] font-semibold mon justify-center hover:bg-[#E3383B] transition">
